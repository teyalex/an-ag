-- Factiva queries
	...
	/* despite the file extension, this isn't SQL code. I just changed the file extension to .sql so that the Boolean operators and numbers are displayed in colored text, making it all easier to read. the queries are pasted into a Factiva search as plain text. */
...
-- Original landscape analysis
	...
	-- Query sections
		-- These were used to assemble the full queries below.
